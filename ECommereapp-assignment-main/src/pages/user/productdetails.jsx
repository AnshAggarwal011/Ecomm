            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
              ...
              <div className="p-8 space-y-6">
                ...
                <div className="border-b border-green-100 pb-6">
                  <h1 className="text-4xl font-bold text-gray-900 mb-3 bg-gradient-to-r from-green-600 to-rose-500 text-transparent bg-clip-text">
                    {product.name}
                  </h1>
                ...
                {/* Description Section */}
                <div className="border-t border-b border-green-100 py-6">
                  ...
                  {/* Add to Cart Button */}
                    <motion.button 
                      ...
                      className={`w-full py-4 rounded-xl hover:shadow-xl transition duration-300 flex items-center justify-center space-x-3 ${
                        ...
                        : 'bg-gradient-to-r from-green-600 to-rose-500 text-white'
                      }`}
