...
export default function OccasionsPage() {
  ...
  return (
    ...
    <Helmet>
      ...
      <Navbar />
      <div className="min-h-screen bg-green-50 py-12 px-4 sm:px-6 lg:px-8 animate-fadeIn">
  ...
  return (
    <div className="relative animate-slideDown">
      <input
        ...
        className="px-4 py-2 border rounded-md shadow-sm focus:ring-2 focus:ring-green-500 focus:outline-none"
...
function OccasionCard({ title, Icon, className }) {
  return (
    ...
    >
      <Icon className="w-12 h-12 text-green-500 mx-auto mb-4 animate-pulse" />
