  ...
  return (
    ...
    <div className="bg-gradient-to-br from-green-50 to-blue-50 min-h-screen">
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        >
          <h1 className="text-5xl font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-green-500 to-purple-600">
            Contact Us
          </h1>
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          >
            <div className="flex items-center mb-6">
              <FaPaperPlane className="text-green-500 mr-4 text-3xl" />
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500 transition-all duration-300"
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                type="submit"
                className="w-full bg-gradient-to-r from-green-500 to-purple-600 text-white py-4 rounded-xl font-semibold hover:from-green-600 hover:to-purple-700 transition-all duration-300 shadow-lg"
              >
                Send Message
              </motion.button>
            </form>
          ...
          >
            <div>
              <div className="flex items-center mb-6">
                <FaMapMarkerAlt className="text-green-500 mr-4 text-3xl" />
              ...
              <div className="space-y-6 mb-8">
                {[
                  ...
                  { 
                    ...
                    title: "Email", 
                    detail: "support@saifashionzonebyraiba.com" 
                  },
                  { 
        ...
        >
          <h2 className="text-4xl font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-green-500 to-purple-600">
